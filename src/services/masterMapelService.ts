...
export const INITIAL_MASTER_MAPEL: MasterMapelItem[] = [
  ...
  { code: "AGM-02", name: "Akidah Akhlak", category: "Keagamaan", jp: "2 JP", target: "Semua Tingkat", teacher: "WAKHIBUN, S.Pd.I., M.Pd", icon: "🕌" },
  { code: "AGM-03", name: "Fikih", category: "Keagamaan", jp: "2 JP", target: "Semua Tingkat", teacher: "CARYATI, S.Ag", icon: "⚖️" },
  ...
  { code: "AGM-05", name: "Bahasa Arab", category: "Keagamaan", jp: "3 JP", target: "Semua Tingkat", teacher: "Hj. SITI MUHSINAH, S.Ag", icon: "🗣️" },
  ...
  { code: "MLK-01", name: "Bahasa Jawa", category: "Muatan Lokal", jp: "2 JP", target: "Semua Tingkat", teacher: "RINDANG FARIHA DIANA, S.Pd", icon: "📜" },
