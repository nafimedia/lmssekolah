...
export const INITIAL_MASTER_MAPEL: MasterMapelItem[] = [
  ...
  { code: "AGM-05", name: "Bahasa Arab", category: "Keagamaan", jp: "3 JP", target: "Semua Tingkat", teacher: "Hj. SITI MUHSINAH, M.Pd", icon: "🗣️" },
  ...
  { code: "UMM-03", name: "Matematika", category: "Umum", jp: "4 JP", target: "Semua Tingkat", teacher: "Hj. ANI YULIANI, S.Pd", icon: "📐" },
