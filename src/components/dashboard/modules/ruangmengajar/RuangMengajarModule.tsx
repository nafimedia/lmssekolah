...
const MASTER_ROMBEL_DATA: Record<string, RombelMeta> = {
  "Kelas VII A": {
    ...
    ruang: "Ruang A.01",
    siswaCount: 34,
    genderRatio: "17 L / 17 P",
    students: [
      { nisn: "0091827301", name: "Abdullah Rofi", gender: "L", hadirPct: 98.2, status: "Hadir" },
      { nisn: "0091827302", name: "Aisyah Humaira", gender: "P", hadirPct: 100, status: "Hadir" },
      { nisn: "0091827303", name: "Baqir Mansur", gender: "L", hadirPct: 94.1, status: "Hadir" },
      { nisn: "0091827304", name: "Bilqis Nabila", gender: "P", hadirPct: 96.5, status: "Hadir" },
      { nisn: "0091827305", name: "Cahyo Utomo", gender: "L", hadirPct: 88.0, status: "Izin" },
    ],
  },
  "Kelas VII B": {
    code: "Kelas VII B",
    tingkat: "VII",
    waliKelas: "Bpk. Slamet Riyadi, M.Pd",
    ruang: "Ruang A.02",
    siswaCount: 35,
    genderRatio: "18 L / 17 P",
    students: [
      { nisn: "0091827310", name: "Deni Ardiansyah", gender: "L", hadirPct: 97.0, status: "Hadir" },
      { nisn: "0091827311", name: "Dina Rosdiana", gender: "P", hadirPct: 95.5, status: "Hadir" },
      { nisn: "0091827312", name: "Faris Al-Faruq", gender: "L", hadirPct: 92.0, status: "Hadir" },
      { nisn: "0091827313", name: "Hanifah Zahra", gender: "P", hadirPct: 98.0, status: "Hadir" },
    ],
  },
  "Kelas VII C": {
    code: "Kelas VII C",
    tingkat: "VII",
    waliKelas: "Ibu Maryati, S.Pd",
    ruang: "Ruang A.03",
    siswaCount: 34,
    genderRatio: "16 L / 18 P",
    students: [
      { nisn: "0091827320", name: "Irfan Hakim", gender: "L", hadirPct: 96.0, status: "Hadir" },
      { nisn: "0091827321", name: "Jasmine Putri", gender: "P", hadirPct: 99.0, status: "Hadir" },
      { nisn: "0091827322", name: "Khairul Amri", gender: "L", hadirPct: 91.5, status: "Hadir" },
    ],
  },
  "Kelas VIII A": {
    code: "Kelas VIII A",
    ...
    ruang: "Ruang B.01",
    siswaCount: 32,
    genderRatio: "16 L / 16 P",
    students: [
      { nisn: "0081928371", name: "Ahmad Fauzi", gender: "L", hadirPct: 95.2, status: "Hadir" },
      { nisn: "0081928372", name: "Fatimah Az-Zahra", gender: "P", hadirPct: 100, status: "Hadir" },
      { nisn: "0081928373", name: "Muhammad Rizky", gender: "L", hadirPct: 76.2, status: "Alpa" },
      { nisn: "0081928374", name: "Siti Nurhaliza", gender: "P", hadirPct: 95.2, status: "Hadir" },
      { nisn: "0081928375", name: "Zaid bin Tsabit", gender: "L", hadirPct: 97.5, status: "Hadir" },
    ],
  },
  "Kelas VIII B": {
    code: "Kelas VIII B",
    tingkat: "VIII",
    waliKelas: "Bpk. Ahmad Syukri, S.Kom",
    ruang: "Ruang B.02",
    siswaCount: 33,
    genderRatio: "17 L / 16 P",
    students: [
      { nisn: "0081928380", name: "Bagus Setiawan", gender: "L", hadirPct: 98.0, status: "Hadir" },
      { nisn: "0081928381", name: "Dewi Lestari", gender: "P", hadirPct: 92.5, status: "Hadir" },
      { nisn: "0081928382", name: "Eko Prasetyo", gender: "L", hadirPct: 88.0, status: "Izin" },
      { nisn: "0081928383", name: "Gita Gutawa", gender: "P", hadirPct: 96.0, status: "Hadir" },
    ],
  },
  "Kelas VIII C": {
    code: "Kelas VIII C",
    tingkat: "VIII",
    waliKelas: "Ibu Ratna Dewi, M.Pd",
    ruang: "Ruang B.03",
    siswaCount: 32,
    genderRatio: "15 L / 17 P",
    students: [
      { nisn: "0081928390", name: "Hasan Basri", gender: "L", hadirPct: 96.5, status: "Hadir" },
      { nisn: "0081928391", name: "Indah Permata", gender: "P", hadirPct: 98.0, status: "Hadir" },
      { nisn: "0081928392", name: "Junaedi", gender: "L", hadirPct: 90.0, status: "Hadir" },
    ],
  },
  "Kelas IX A": {
    code: "Kelas IX A",
    ...
    genderRatio: "18 L / 17 P",
    students: [
      { nisn: "0071928400", name: "Khadijah", gender: "P", hadirPct: 99.0, status: "Hadir" },
      { nisn: "0071928401", name: "Lukman Hakim", gender: "L", hadirPct: 94.0, status: "Hadir" },
      { nisn: "0071928402", name: "M. Ma'ruf", gender: "L", hadirPct: 95.5, status: "Hadir" },
    ],
  },
  "Kelas IX B": {
    code: "Kelas IX B",
    tingkat: "IX",
    waliKelas: "Ustadz H. Mohammad Fathoni, M.Pd",
    ruang: "Ruang C.02",
    siswaCount: 34,
    genderRatio: "16 L / 18 P",
    students: [
      { nisn: "0071928410", name: "Nabila Syakieb", gender: "P", hadirPct: 97.5, status: "Hadir" },
      { nisn: "0071928411", name: "Omar Daniel", gender: "L", hadirPct: 93.0, status: "Hadir" },
    ],
  },
  "Kelas IX C": {
    code: "Kelas IX C",
    tingkat: "IX",
    waliKelas: "Bpk. Budi Santoso, M.Pd",
    ruang: "Ruang C.03",
    siswaCount: 31,
    genderRatio: "15 L / 16 P",
    students: [
      { nisn: "0071928420", name: "Putri Rahayu", gender: "P", hadirPct: 98.5, status: "Hadir" },
      { nisn: "0071928421", name: "Qomaruddin", gender: "L", hadirPct: 91.0, status: "Hadir" },
      { nisn: "0071928422", name: "Raihan Fadhil", gender: "L", hadirPct: 96.0, status: "Hadir" },
    ],
  },
};
