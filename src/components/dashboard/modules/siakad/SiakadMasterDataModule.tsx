...
export function SiakadMasterDataModule() {
  ...
  const rombelJadwalMap: Record<string, { hari: string; jam: string; mapel: string; guru: string }[]> = {
    "VII A": [
      { hari: "Senin", jam: "07.30 - 08.15", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
      { hari: "Senin", jam: "08.15 - 09.00", mapel: "PJOK", guru: "NUR ROCHMAN SHODIQ, S.Pd.I" },
      { hari: "Selasa", jam: "07.30 - 08.15", mapel: "Tahfidz & Murottal", guru: "MISBAH AHMAD DANI, S.Pd" },
      { hari: "Rabu", jam: "08.30 - 09.30", mapel: "Al Qur'an Hadis", guru: "AH. SYARIF HIDAYAH, S.Pd.I" },
      { hari: "Kamis", jam: "08.30 - 09.30", mapel: "Pendidikan Kewarganegaraan", guru: "ANGGUN NOVTALIA BERLIAN, S.Pd" },
      { hari: "Jumat", jam: "08.30 - 09.30", mapel: "Bahasa Arab", guru: "ENDAH SUPRIHATIN, S.Pd" },
      { hari: "Sabtu", jam: "07.30 - 09.00", mapel: "Fikih", guru: "CARYATI," },
    ],
    "VII B": [
      { hari: "Senin", jam: "07.30 - 08.15", mapel: "Ilmu Pendidikan Alam", guru: "NOVANTYA KARTIKAWATI, S.Pd" },
      { hari: "Selasa", jam: "08.30 - 09.30", mapel: "Bahasa Arab", guru: "ENDAH SUPRIHATIN, S.Pd" },
      { hari: "Rabu", jam: "08.15 - 09.00", mapel: "Ilmu Pendidikan Alam", guru: "NOVANTYA KARTIKAWATI, S.Pd" },
      { hari: "Kamis", jam: "08.30 - 09.30", mapel: "Fikih", guru: "CARYATI," },
      { hari: "Jumat", jam: "08.30 - 09.30", mapel: "PJOK", guru: "NUR ROCHMAN SHODIQ, S.Pd.I" },
      { hari: "Sabtu", jam: "07.30 - 09.00", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
    ],
    "VIII A": [
      { hari: "Senin", jam: "07.30 - 08.30", mapel: "PJOK", guru: "NUR ROCHMAN SHODIQ, S.Pd.I" },
      { hari: "Selasa", jam: "08.30 - 09.30", mapel: "Ilmu Pendidikan Alam", guru: "NOVANTYA KARTIKAWATI, S.Pd" },
      { hari: "Rabu", jam: "10.00 - 10.45", mapel: "Fikih", guru: "CARYATI," },
      { hari: "Kamis", jam: "08.15 - 09.00", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
      { hari: "Jumat", jam: "08.30 - 09.30", mapel: "Al Qur'an Hadis", guru: "AH. SYARIF HIDAYAH, S.Pd.I" },
      { hari: "Sabtu", jam: "07.30 - 09.00", mapel: "Akidah Akhlak", guru: "WAKHIBUN, S.P" },
    ],
    "VIII B": [
      { hari: "Senin", jam: "07.30 - 08.15", mapel: "Pendidikan Kewarganegaraan", guru: "ANGGUN NOVTALIA BERLIAN, S.Pd" },
      { hari: "Selasa", jam: "10.45 - 11.30", mapel: "Al Qur'an Hadis", guru: "AH. SYARIF HIDAYAH, S.Pd.I" },
      { hari: "Rabu", jam: "08.30 - 09.30", mapel: "Bahasa Inggris", guru: "ACHMAD MAKMUN ROSID, S.Pd., M.Pd" },
      { hari: "Kamis", jam: "08.15 - 09.00", mapel: "Ilmu Pendidikan Alam", guru: "NOVANTYA KARTIKAWATI, S.Pd" },
      { hari: "Jumat", jam: "08.30 - 09.30", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
      { hari: "Sabtu", jam: "09.15 - 10.45", mapel: "PJOK", guru: "NUR ROCHMAN SHODIQ, S.Pd.I" },
    ],
    "IX A": [
      { hari: "Senin", jam: "07.30 - 08.30", mapel: "Bahasa Jawa", guru: "RINDANG FARIHA IDANA, S.Pd" },
      { hari: "Selasa", jam: "08.15 - 09.00", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
      { hari: "Rabu", jam: "08.15 - 09.00", mapel: "Bahasa Indonesia", guru: "SOBIYATI, S.Pd" },
      { hari: "Kamis", jam: "08.15 - 09.00", mapel: "Al Qur'an Hadis", guru: "AH. SYARIF HIDAYAH, S.Pd.I" },
      { hari: "Jumat", jam: "08.30 - 09.30", mapel: "Akidah Akhlak", guru: "WAKHIBUN, S.P" },
      { hari: "Sabtu", jam: "07.30 - 09.00", mapel: "PJOK", guru: "NUR ROCHMAN SHODIQ, S.Pd.I" },
    ],
    "IX B": [
      { hari: "Senin", jam: "07.30 - 08.15", mapel: "Ilmu Pendidikan Alam", guru: "NOVANTYA KARTIKAWATI, S.Pd" },
      { hari: "Selasa", jam: "10.00 - 10.45", mapel: "Al Qur'an Hadis", guru: "AH. SYARIF HIDAYAH, S.Pd.I" },
      { hari: "Rabu", jam: "08.30 - 09.30", mapel: "Bahasa Inggris", guru: "ACHMAD MAKMUN ROSID, S.Pd., M.Pd" },
      { hari: "Kamis", jam: "09.15 - 10.00", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
      { hari: "Jumat", jam: "09.45 - 10.45", mapel: "Fikih", guru: "CARYATI," },
      { hari: "Sabtu", jam: "07.30 - 09.00", mapel: "Matematika", guru: "SAYONO, S.Pd., M.Pd." },
    ],
  };
