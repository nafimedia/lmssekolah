    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg border-border bg-card">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div>
            <Label className="text-xs font-semibold">Tugas Tambahan / Peran</Label>
            <Input placeholder="Contoh: Guru Pengampu / Wali Kelas 8A / Pembina Ekstrakulikuler" value={formTugas} onChange={(e) => setFormTugas(e.target.value)} className="mt-1 text-xs" />
          </div>
